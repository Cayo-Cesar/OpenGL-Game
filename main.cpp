...
#define FLAP_STRENGTH 0.04f  // ForÃ§a do flap
...
void drawCloud(float x, float y, float z) {
    glColor4f(1.0f, 1.0f, 1.0f, 0.8f); // Cor branca com transparÃªncia

    glPushMatrix();
    glTranslatef(x, y, z);

    // Desenha vÃ¡rias esferas para criar uma nuvem
